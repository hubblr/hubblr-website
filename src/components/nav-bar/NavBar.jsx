...
const NavBar = React.forwardRef(
  ({ leftContent, rightContent, className, collapsedClassName, showNavBar }, ref) => {
    ...
    return (
      <div
        className={`navbar fixed top-0 w-full z-50 px-1 ${className} ${
          !isCollapsed ? `h-screen overflow-y-scroll bg-black ${collapsedClassName}` : ''
        } ${isVisible ? '' : 'opacity-0'}`}
      >
        <div
          className={`${
