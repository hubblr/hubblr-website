...
function ScrollAnimatedElement_OLD({ wrappedElement, wrapperStyleClasses, transforms }) {
...
ScrollAnimatedElement_OLD.defaultProps = {
  wrapperStyleClasses: '',
};

ScrollAnimatedElement_OLD.propTypes = {
...
export default ScrollAnimatedElement_OLD;
