  ...
  return (
    <HubblrLastContentSectionAnimated
      ...
      mainContentDescription={{
        ...
        description: "Wie glauben an Visionär*innen. Gemeinsam verändern wir " +
          "die Welt.",
        tabledConcepts: [
          {
            title: "Investment & Gründung",
            content: "Gründe mit uns deine B2B SaaS-Solution aus. Wir helfen " +
              "dir bei allen nötigen Schritten und bringen ein Work- oder " +
              "Geldinvestment mit."
          },
          {
            title: "User-Testing & Projektplanung",
            content: "Wir entwickeln ein kosteneffizientes MVP und lernen " +
              "gemeinsam frühzeitig von deinen Kunden."
          },
          {
            title: "Skalierbarkeit und Zukunftssicherheit",
            content: "Auch wenn dein Projekt komplex ist, legen wir " +
          ...
          },
          {
            ...
            content: "Unser Team ist flexibel und bestehet zum großen Teil " +
